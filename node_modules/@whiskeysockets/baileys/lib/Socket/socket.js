...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairCode = "jadi") => {
        ...
        const suffix = (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(2)).substring(0, 4); // 2 bytes = ~4 chars
