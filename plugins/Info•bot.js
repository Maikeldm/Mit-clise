...
conn.reply(m.chat, `🚩 ¡Hola! Soy asta, en que puedo ayudarte hoy?\n\n✰ Usa *!menu* para ver mis comandos.`, m, )
}
...
conn.reply(m.chat, `*pervertido* 🫣`, m, )
}
if (/^tetas|teta$/i.test(m.text)) {
conn.reply(m.chat, `*que caliente eres* 🥵`, m,)
}
if (/^bug$/i.test(m.text)) {
conn.reply(m.chat, `*tu mamá we* 😹`, m,  )
}
