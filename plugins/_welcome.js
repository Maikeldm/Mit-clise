...
export async function before(m, { conn, participants, groupMetadata }) {
 ...
 if (chat.welcome && m.messageStubType === 27) {
    ...
    newsletterJid: "120363386763104776@newsletter",
    serverMessageId: '', 
    newsletterName: ' 𝙼𝚒𝚝 𝚌𝚕𝚒𝚜𝚎' }, forwardingScore: 9999999, isForwarded: true, mentionedJid: getMentionedJid(), "externalAdReply": { 
    "title": `♧ ＷＥＬＣＯＭＥ ⫷┈┈╯`, 
    "body": `${userName}`, 
    "previewType": "PHOTO", 
    "thumbnailUrl": null,
