...
import { proto, generateWAMessageFromContent, generateWAMessageContent } from 'baron-baileys-v2';

let handler = async (m, { conn, text }) => {
if (!text) { return conn.reply(m.chat, 'Ingresa el texto que quieras buscar twitter', m,); }
